...
{
    if (!_animationView) {
        _animationView = [[UIImageView alloc]initWithFrame:CGRectMake((ScreenWidth - 120)*0.5, (ScreenHeight - 120)*0.5, 120, 120)];
    }
...
{
    if (!_cutdownLabel) {
        _cutdownLabel = [[UILabel alloc]initWithFrame:CGRectMake((ScreenWidth - 120)*0.5, (ScreenHeight - 120)*0.5, 120, 120)];
