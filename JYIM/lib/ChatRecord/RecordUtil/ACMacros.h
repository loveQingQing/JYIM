...
#define ITTAssert(condition, ...)                                                                                                                                                                                                                   \
    ...
    {                                                                                                                                                                                                                                               \
        if(!(condition))                                                                                                                                                                                                                            \
        {                                                                                                                                                                                                                                           \
            [[NSAssertionHandler currentHandler] handleFailureInFunction:[NSString stringWithFormat:@"< %s >", __PRETTY_FUNCTION__] file:[[NSString stringWithUTF8String:__FILE__] lastPathComponent] lineNumber:__LINE__ description:__VA_ARGS__]; \
        }                                                                                                                                                                                                                                           \
    } while(0)
