...
{
    __block DACircularProgressLayer * thelayer = nil;
    dispatch_async(dispatch_get_main_queue(), ^{
        
       thelayer = (DACircularProgressLayer * ) self.layer;
    });
    return thelayer;
}
...
- (void)setProgress:(CGFloat)progress animated:(BOOL)animated
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        [weakSelf.layer removeAnimationForKey:@"indeterminateAnimation"];
        [weakSelf.circularProgressLayer removeAnimationForKey:@"progress"];
    });
